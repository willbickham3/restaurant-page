...
import { imageCreater, containerDiv } from "../createrFunctions/imageCreater";
import subSectionCreater from "../createrFunctions/subsection";
...
function createMenu() {
    const menuContainer = containerDiv('div', 'menu', null);
